...
- **`docs/PERFORMANCE-STATUS.md` contradicted `docs/BENCHMARK-RESULTS.md`** on Datafaker throughput (name 47K vs 23K, email 34K vs 24K). Both were stale; reconciled against the July 2026 re-run
